...
pkg_postinst() {
	einfo "These u-boot files are for the TI Pandaboard."
	einfo "If you are not using these files for a pandaboard or clones, we recommend"
