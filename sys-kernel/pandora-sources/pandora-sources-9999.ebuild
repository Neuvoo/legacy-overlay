...
DESCRIPTION="Official git kernel for the OpenPandora."
EGIT_REPO_URI="git://openpandora.org/pandora-kernel.git"
...
pkg_postinst() {
	...
	einfo "${HOMEPAGE}"
	einfo "To use the default pandora config, type 'make omap_pandora_defconfig'"
}
